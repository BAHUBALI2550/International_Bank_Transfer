...
async function createAccount(customerID, bankID, balance, currency) {
    try {
        ...
        await statefulTxn.submit(accountID, customerID, bankID, balance, currency);
        console.log("* Result: commited");
...
async function fetchCustomerAccounts(customerID) {
    ...
    return customerAccounts;
        ...
        console.error("Error:", error);
        throw new Error("Failet to fetch customer accounts");
    }
}
