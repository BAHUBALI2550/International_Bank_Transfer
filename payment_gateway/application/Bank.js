...
async function createBank(bankID,bankadminID,name,password,country,currency,reserves) {
    try {
        const certFile = "/path/to/certificate.pem";
        const agent = new https.Agent({ca: fs.readFileSync(certFile),
...
async function getExchangeRate(fromCurrency, toCurrency) {
  ...
  async function createBankWithExchangeRate(bankID,bankadminID,name,password,country,currency,reserves) {
    try {
